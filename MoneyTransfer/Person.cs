...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"{name} has ${wallet.money} in the wallet.");
        }
        ...
        public bool TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            if(amountToTransfer <= wallet.money)
            {
                ...
                Console.WriteLine($"${amountToTransfer} was sent from {name} to {receiver.name}");
                return true;
            }
            else
            {
                Console.WriteLine("Sorry, transaction couldn't be complete. Insufficient funds");
                return false;
            }
        }
