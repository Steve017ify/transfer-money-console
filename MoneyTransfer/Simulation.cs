...
namespace MoneyTransfer
{
    internal class Simulation
    {
        ...
        public void RunSimulation()
        {
            ...
            Person personOne = new Person("John", 250);
            Person personTwo = new Person("Rita", 150);
            ...
            //TODO 9: Call the .TransferMoney() method on one person object (giver), making sure to pass in the second person object (receiver), and the amount being transferred. One line.
            personOne.TransferMoney(personTwo, 25);
